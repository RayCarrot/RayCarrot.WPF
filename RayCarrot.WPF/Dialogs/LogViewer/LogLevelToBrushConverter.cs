...
namespace RayCarrot.WPF
{
    ...
    internal class LogLevelToBrushConverter : BaseValueConverter<LogLevelToBrushConverter, LogLevel, object>
    {
        ...
        {
            return new SolidColorBrush((Color)ColorConverter.ConvertFromString(RCFCore.Data.GetConfigurationValue<Func<LogLevel, string>>(RCFWPF.LogLevelColorsConfigKey, GetDefaultColor).Invoke(value)));
