...
namespace RayCarrot.WPF
{
    ...
    {
        /// <summary>
        /// Adds a <see cref="IWPFStyle"/> to the service collection
        /// </summary>
        /// <typeparam name="S">The style to add</typeparam>
        /// <param name="services">The services</param>
        /// <returns>The services</returns>
        public static IServiceCollection AddWPFStyle<S>(this IServiceCollection services)
            where S : class, IWPFStyle, new()
        {
            // Add the service
            services.AddTransient<IWPFStyle, S>();
